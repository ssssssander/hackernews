...
@section('content')
    <div class="col-md-10 col-md-offset-1">
        ...
        <div class="panel panel-default">
            ...
            <a class="btn btn-danger btn-xs pull-right" href="{{ route('delete_article', ['article' => $article->id]) }}">
            ...
            <div class="panel-content">
                ...
                <form action="{{ route('update_article', ['article' => $article->id]) }}" class="form-horizontal" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" id="article-title" name="title" type="text" value="{{ $article->title }}" maxlength="255">
                        </div>
                    </div>
                    <!-- Article url -->
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" id="article-url" name="url" type="text" value="{{ $article->url }}" maxlength="1000">
                        </div>
                    </div>
                    <!-- Add Article Button -->
                    <div class="form-group">
